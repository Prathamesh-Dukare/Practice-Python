...
b1.pack()
b2=Button(f1,text='File1',background="green",padx=60,pady=5, relief=RAISED,font='monospace 12 italic')
b2.pack()
b3=Button(f1,text='File2',background="green",padx=60,pady=5, relief=RAISED,font='monospace 12 italic')
b3.pack()
b4=Button(f1,text='File3',background="green",padx=60,pady=5, relief=RAISED,font='monospace 12 italic')
b4.pack()
